...
public:
  ...
  // lyc modification
  // isSymbolicValue, checks whether the value is symbolic given the pointer to it
  // returns the index of mo, -1 if mo is not a symbolic value
  int isSymbolic(MemoryObject * mo);
};
