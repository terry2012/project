...
uint64_t BufferObject :: getStartAddr() {
	return this->startAddr;
}

uint64_t BufferObject :: getSize() {
	return this->size;
}

BufferObject::BufferObject(MemoryObject * mo) {
	this->startAddr = 0;   
	this->size = 0;       
	this->mo = mo;
}

void BufferObject :: setStartAddr(uint64_t addr){
	this->startAddr = addr;
}

void BufferObject :: setSize(unsigned size){
	this->size = size;
}
