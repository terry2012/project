...
!1 = metadata !{i32 589865, metadata !"mempcpy.c", metadata !"/home/gfj/project/src/klee_symbolic_execution/runtime/Intrinsic/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"mempcpy.c", metadata !"/home/gfj/project/src/klee_symbolic_execution/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
